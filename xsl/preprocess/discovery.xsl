...
<!--
    ...
    8/5/15 dabaker - Made change to show filters by default on advanced search
...
<xsl:stylesheet
        ...
        <div>
            ...
            <div rend="clearfix">
                <p rend="pull-right">
                    ...
                    <xref target="#" rend="hide-advanced-filters"> <!-- dabaker - change hide/show label -->
    ...
    <xsl:template match="dri:div[@id='aspect.discovery.SimpleSearch.div.discovery-filters-wrapper']">
        <div>
            ...
            </xsl:attribute> --> <!-- dabaker - Show filters -->
            <xsl:apply-templates/>
        </div>
    </xsl:template>
