 ...
 */
 ...
 /*
  * 9/23/15 - dabaker - Keep subtrees open when clicking other subtree
  * 9/24/15 - dabaker - Close descendant subtrees when closing subtree
  */
...
(function($) {
    ...
    function init_community_list() {
        $('.community-browser-row .toggler').click(function() {
            ...
            /* dabaker - Prevent closing of subtree when another is opened */           
            /*other_wrappers.addClass('hidden');*/
            /* dabaker - close descendants */ descendant_wrappers = $(target_id).find('.sub-tree-wrapper');
            ...
            if (target.is(':visible')) {
                /* dabaker - close descendants */ descendant_wrappers.addClass('hidden');
